...
describe('Routes', function() {
  ...
  describe('/characters', function() {
    ...
    xit('POST devuelve un mensaje de error si el la familia no existe', function() {
      return supertest
        .post('/characters')
        .send({name: 'Homero', age: 36, family: 'Simpsons'})
        .expect(400)
  ...
  describe('/characters/:name', function() {
    ...
    xit('GET responde con un array de SÓLO los nombres todos los personajes de esa familia cuando pluck es true', function() {
      model.addFamily('Simpsons');
      model.addFamily('Gorgory');
      model.addCharacter('Homero', 36, "Simpsons");
      model.addCharacter('Bart', 10, "Simpsons");
